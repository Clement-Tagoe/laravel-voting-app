...
class CommentNotificationsTest extends TestCase
{
    ...
    /** @test */
    public function notifications_count_greater_than_threshold_shows_for_logged_in_user()
    {
        $user = User::factory()->create();
        $idea = Idea::factory()->create([
            'user_id' => $user->id,
    ...
    /** @test */
    public function notification_comments_deleted_redirects_to_index_page()
    {
        $user = User::factory()->create();
        $idea = Idea::factory()->create([
            'user_id' => $user->id,
