...
class ShowCommentsTest extends TestCase
{
    ...
    /** @test */
    public function idea_comments_livewire_components_renders() 
    {
    ...
    /** @test */
    public function idea_comment_livewire_components_renders() 
    {
        $idea = Idea::factory()->create();
    ...
    public function list_of_comments_shows_on_idea_page() 
    {
        ...
        $this->get(route('idea.show', $idea))
            ...
            ->assertSee('2 comment(s)');
    }

    /** @test */
    public function comments_count_shows_on_index_page() 
    {
        $idea = Idea::factory()->create();
