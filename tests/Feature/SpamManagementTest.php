...
class SpamManagementTest extends TestCase
{
    ...
    /** @test */
    public function marking_an_idea_as_spam_shows_on_menu_when_user_does_has_authorization() 
    {
        $user = User::factory()->create();
    ...
    /** @test */
    public function marking_an_idea_as_spam_dose_not_show_on_menu_when_user_does_not_have_authorization() 
    {
        $idea = Idea::factory()->create();
