        ...
        @foreach ($ideas as $idea)
            ...
            <div class="idea-container hover:shadow-md transition duration-150 ease-in bg-white rounded-xl flex cursor-pointer">
                <div class="hidden md:block border-r border-gray-100 px-5 py-8">
                    ...
                    <div class="mt-8">
                        <button class="w-20 bg-gray-200 font-bold border border-gray-200 hover:border-gray-400 text-xxs uppercase rounded-xl transition duration-150 ease-in px-4 py-3">Vote</button>
                    </div>
                </div>
