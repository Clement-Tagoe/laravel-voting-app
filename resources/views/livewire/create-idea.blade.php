    ...
    @else
        <div class="my-6 text-center">
            <a
                ...
                href="{{ route('login') }}"
                class="inline-block justify-center w-1/2 h-11 text-xs bg-blue-600 text-white font-semibold rounded-xl border border-blue-600 hover:bg-blue-500 transition duration-150 ease-in px-6 py-3"
            >
                Login
            </a>
            <a
