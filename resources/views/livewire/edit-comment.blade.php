      ...
      <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
        ...
        >
            ...
            <form wire:submit.prevent="updateComment" action="" method="POST" class="space-y-4 px-4 py-6">
                ...
                <div>
                    <textarea x-ref="editComment" wire:model.defer="body" name="idea" id="idea" cols="30" rows="4" class="w-full bg-gray-100 rounded-xl placeholder-gray-900 border-none text-sm px-4 py-2" placeholder="Edit your comment" required></textarea>
                    @error('body')
